...
exports.default = (function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    var authorization, _a, token, data, id, name_1, email, username, profilePhoto, friends, user, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                id = data.id, name_1 = data.name, email = data.email, username = data.username, profilePhoto = data.profilePhoto, friends = data.friends;
